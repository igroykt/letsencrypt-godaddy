...
class Func:
    ...
    @classmethod
    def exportCredentials(self, API_KEY, API_SECRET):
        try:
            os.environ['GDKEY'] = API_KEY
            os.environ['GDSECRET'] = API_SECRET
        except Exception as err:
    ...
    def GD_inputCreds(self):
        try:
            ...
            raise Exception(f'GD_inputCreds: {err}')